...
const router_1 = require("./ml/router");
class AIMarketplaceClient {
    constructor(options) {
        ...
        this.config = {
            router: { ...types_1.DEFAULT_ROUTER_CONFIG, ...(_a = options.config) === null || _a === void 0 ? void 0 : _a.router },
            cache: { ...types_1.DEFAULT_CACHE_CONFIG, ...(_b = options.config) === null || _b === void 0 ? void 0 : _b.cache },
            ...
            defaultProvider: (_h = (_g = options.config) === null || _g === void 0 ? void 0 : _g.defaultProvider) !== null && _h !== void 0 ? _h : types_1.APIProvider.OPENAI,
        ...
        this.mlRouter = new router_1.MLIntelligentRouter();
    ...
    initializeProviders(baseUrls) {
        ...
        if (this.apiKeys.openai) {
            this.providers.set(types_1.APIProvider.OPENAI, new openai_1.OpenAIProvider());
        }
        if (this.apiKeys.anthropic) {
            this.providers.set(types_1.APIProvider.ANTHROPIC, new anthropic_1.AnthropicProvider());
        }
        if (this.apiKeys.google) {
            this.providers.set(types_1.APIProvider.GOOGLE, new google_1.GoogleProvider());
        }
    }
...
exports.AIMarketplaceClient = AIMarketplaceClient;
