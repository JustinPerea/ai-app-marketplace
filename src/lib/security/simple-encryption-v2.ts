/**
 * Simple Encryption Service for Development (Node.js v22 Compatible)
 * 
 * Uses the correct Node.js crypto API for modern versions
 */
...
export class SimpleEncryptionService {
  ...
  /**
   * Encrypt API key using AES-256-GCM (Node.js v22+ compatible)
   */
