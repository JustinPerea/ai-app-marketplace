          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto md:h-96">
              ...
              <div className="glass-card p-8 group hover:scale-105 transition-transform flex flex-col h-full">
                ...
                <button className="w-full mt-6 px-8 py-4 flex items-center justify-center space-x-2 rounded-xl font-medium border-2 transition-all duration-300 hover:scale-105" 
                        style={{ 
