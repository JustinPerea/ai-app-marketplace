...
import { requireDeveloper, getUserApps } from '@/lib/auth/developer-auth';
...
export async function POST(request: NextRequest) {
  try {
    // Authenticate and require developer profile
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Build query filters - only show apps for authenticated developer
